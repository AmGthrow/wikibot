...
new_pages = [wiki_page for wiki_page in new_pages if search(
    '^\/wiki\/.*$', wiki_page)]    # only keep wiki_pages that look like '\wiki\<something>' TODO: Make the regex ignore '/wiki/Wikipedia:about' and similar
